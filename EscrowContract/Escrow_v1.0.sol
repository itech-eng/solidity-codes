...
contract Escrow {
    ...
    function deleteOwner(address _account) external onlyAdmin returns(bool) {
        require(_account != msg.sender, "You can't delete yourself from owner.");
    ...
    function withdrawTrx(address payable to, uint256 amount) external onlyOwner returns(bool) {
    ...
    external onlyOwner returns(bool) {
        ...
        require(_payee != msg.sender, "Owner can't be the payee.");
